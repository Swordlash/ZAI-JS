...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["DOM.HTML.Indexed.ScopeValue"] = $PS["DOM.HTML.Indexed.ScopeValue"] || {};
  var exports = $PS["DOM.HTML.Indexed.ScopeValue"];
  ...
  exports["renderScopeValue"] = renderScopeValue;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  exports["isPropScopeValue"] = isPropScopeValue;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Data.Fixed"] = $PS["Data.Fixed"] || {};
  var exports = $PS["Data.Fixed"];
  ...
  var fromInt = function (dictKnownPrecision) {
      var $75 = fromBigInt(dictKnownPrecision);
      return function ($76) {
          return $75(Data_BigInt.fromInt($76));
      };
  };
  ...
  var round = function (dictKnownPrecision) {
      return function (n) {
          ...
          var x = (function () {
              ...
              throw new Error("Failed pattern match at Data.Fixed (line 297, column 3 - line 299, column 21): " + [  ]);
          })();
...
(function($PS) {
  ...
  exports["genericArbitrary"] = genericArbitrary;
  exports["arbNumber"] = arbNumber;
  exports["arbInt"] = arbInt;
  exports["arbitraryNoArguments"] = arbitraryNoArguments;
  exports["arbGenSumSum"] = arbGenSumSum;
  exports["arbGenSumConstructor"] = arbGenSumConstructor;
  exports["arbitrarySum"] = arbitrarySum;
  exports["arbitraryConstructor"] = arbitraryConstructor;
  exports["arbitraryArgument"] = arbitraryArgument;
  exports["arbitraryRowListNil"] = arbitraryRowListNil;
  exports["arbitraryRowListCons"] = arbitraryRowListCons;
  exports["arbitraryRecordInstance"] = arbitraryRecordInstance;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
...
(function($PS) {
  ...
  var formatDate = function (d) {
      return Data_Formatter_DateTime.format(Data_List.fromFoldable(Data_Foldable.foldableArray)([ Data_Formatter_DateTime.DayOfMonth.value, new Data_Formatter_DateTime.Placeholder("-"), Data_Formatter_DateTime.MonthTwoDigits.value, new Data_Formatter_DateTime.Placeholder("-"), Data_Formatter_DateTime.YearFull.value ]))(new Data_DateTime.DateTime(d, Data_Bounded.bottom(Data_Time.boundedTime)));
  };   
  var cl = function ($2) {
      return Halogen_HTML_Properties.class_(Web_HTML_Common.ClassName($2));
  };
  exports["cl"] = cl;
...
(function($PS) {
  ...
  var Mathematics = (function () {
      ...
      Mathematics.value = new Mathematics();
      return Mathematics;
  })();
  var ComputerScience = (function () {
      function ComputerScience() {

      };
      ComputerScience.value = new ComputerScience();
  ...
  var Linguistics = (function () {
      function Linguistics() {

      };
      Linguistics.value = new Linguistics();
      return Linguistics;
  })();
  var Other = (function () {
      function Other() {
  ...
  var IssueDate = function (x) {
      return x;
  };
  var Description = function (x) {
      return x;
  };
  var Books = function (x) {
      return x;
  };
  var showURL = {
      show: function (v) {
  ...
  var showMoney = {
      show: function (v) {
          return Data_Show.show(Data_Show.showNumber)(Data_Fixed.toNumber(Data_Fixed.knownPrecisionTenTimes(Data_Fixed.knownPrecisionTenTimes(Data_Fixed.knownPrecisionOne)))(v));
      }
  };
  var showIssueDate = {
      show: function (v) {
  ...
  var genericSubject_ = {
      to: function (x) {
          ...
          if (x instanceof Data_Generic_Rep.Inr && x.value0 instanceof Data_Generic_Rep.Inl) {
              return Mathematics.value;
          };
          if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0 instanceof Data_Generic_Rep.Inl)) {
              return ComputerScience.value;
          };
          ...
          throw new Error("Failed pattern match at Types (line 125, column 1 - line 125, column 34): " + [ x.constructor.name ]);
      },
      from: function (x) {
          if (x instanceof Physics) {
              return new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value);
          };
          if (x instanceof Mathematics) {
              return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value));
          };
          if (x instanceof ComputerScience) {
              return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value)));
          };
          if (x instanceof Chemistry) {
              return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value))));
          };
          if (x instanceof Geography) {
  ...
  var showSubject = {
      show: Data_Show_Generic.genericShow(genericSubject_)(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsNoArguments)({
  ...
  var arbitraryURL = {
      arbitrary: Control_Bind.bind(Test_QuickCheck_Gen.bindGen)(Test_QuickCheck_Arbitrary.arbitrary(Test_QuickCheck_Arbitrary.arbInt))(function (seed) {
          return Control_Applicative.pure(Test_QuickCheck_Gen.applicativeGen)(URL("https://picsum.photos/seed/" + (Data_Show.show(Data_Show.showInt)(seed) + "/128")));
      })
  };
  var arbitrarySubject = {
      arbitrary: Test_QuickCheck_Arbitrary.genericArbitrary(genericSubject_)(Test_QuickCheck_Arbitrary.arbitrarySum(Test_QuickCheck_Arbitrary.arbitraryConstructor(Test_QuickCheck_Arbitrary.arbitraryNoArguments))(Test_QuickCheck_Arbitrary.arbGenSumSum(Test_QuickCheck_Arbitrary.arbitraryConstructor(Test_QuickCheck_Arbitrary.arbitraryNoArguments))(Test_QuickCheck_Arbitrary.arbGenSumSum(Test_QuickCheck_Arbitrary.arbitraryConstructor(Test_QuickCheck_Arbitrary.arbitraryNoArguments))(Test_QuickCheck_Arbitrary.arbGenSumSum(Test_QuickCheck_Arbitrary.arbitraryConstructor(Test_QuickCheck_Arbitrary.arbitraryNoArguments))(Test_QuickCheck_Arbitrary.arbGenSumSum(Test_QuickCheck_Arbitrary.arbitraryConstructor(Test_QuickCheck_Arbitrary.arbitraryNoArguments))(Test_QuickCheck_Arbitrary.arbGenSumSum(Test_QuickCheck_Arbitrary.arbitraryConstructor(Test_QuickCheck_Arbitrary.arbitraryNoArguments))(Test_QuickCheck_Arbitrary.arbGenSumSum(Test_QuickCheck_Arbitrary.arbitraryConstructor(Test_QuickCheck_Arbitrary.arbitraryNoArguments))(Test_QuickCheck_Arbitrary.arbGenSumSum(Test_QuickCheck_Arbitrary.arbitraryConstructor(Test_QuickCheck_Arbitrary.arbitraryNoArguments))(Test_QuickCheck_Arbitrary.arbGenSumConstructor(Test_QuickCheck_Arbitrary.arbitraryNoArguments))))))))))
  };
  var arbitraryMoney = {
      arbitrary: Data_Functor.map(Test_QuickCheck_Gen.functorGen)((function (dictPartial) {
          var $88 = Data_Maybe.fromJust();
          var $89 = Data_Fixed.fromNumber(Data_Fixed.knownPrecisionTenTimes(Data_Fixed.knownPrecisionTenTimes(Data_Fixed.knownPrecisionOne)));
          return function ($90) {
              return Money($88($89((function (v) {
                  return v * 100.0;
              })($90))));
          };
      })())(Test_QuickCheck_Arbitrary.arbitrary(Test_QuickCheck_Arbitrary.arbNumber))
  };
  var arbitraryIssueDate = {
      arbitrary: Data_Functor.map(Test_QuickCheck_Gen.functorGen)(IssueDate)(Data_Date_Gen.genDate(Test_QuickCheck_Gen.monadGenGen))
  };
  var twoPartGen = function (construct) {
      return function (arbStart) {
          return function (arbEnd) {
              return Data_Functor.map(Test_QuickCheck_Gen.functorGen)((function () {
                  var $91 = Data_String_Common.joinWith(" ");
                  return function ($92) {
                      return construct($91($92));
                  };
              })())(Data_Traversable.sequence(Data_Traversable.traversableArray)(Test_QuickCheck_Gen.applicativeGen)(Data_Functor.map(Data_Functor.functorArray)(function ($93) {
                  return Test_QuickCheck_Gen.elements(Data_Array_NonEmpty_Internal.NonEmptyArray($93));
              })([ arbStart, arbEnd ])));
          };
      };
  };
  var arbitraryDescription = {
      arbitrary: twoPartGen(Description)([ "Wonderful", "Nice", "Insightful", "Best selling", "Ingenious", "A hard-to-forget" ])([ "book", "coursebook for students", "thing to read", "read", "story" ])
  };
  var arbitraryTitle = {
      arbitrary: twoPartGen(Title)([ "The short history of", "All about", "Advanced", "Elements of", "Basics of" ])([ "atoms", "dinosaurs", "languages", "international law", "monetary policy" ])
  };
  var arbSurname = Test_QuickCheck_Gen.elements([ "Newman", "Bond", "Einstein", "Bloch", "String", "Marlow", "Fiennes", "Chopin", "Charles", "Bradshaw" ]);
  var arbName = Test_QuickCheck_Gen.elements([ "John", "James", "Albert", "Josh", "Jack", "George", "Ralph", "Jane", "Amanda", "Carrie" ]);
  var arbitraryAuthor = {
      arbitrary: Control_Bind.bind(Test_QuickCheck_Gen.bindGen)(arbName)(function (name) {
          return Control_Bind.bind(Test_QuickCheck_Gen.bindGen)(arbSurname)(function (surname) {
              return Control_Applicative.pure(Test_QuickCheck_Gen.applicativeGen)({
                  name: name,
                  surname: surname
              });
  ...
  var arbitraryBook = {
      arbitrary: Test_QuickCheck_Arbitrary.genericArbitrary(genericBook_)(Test_QuickCheck_Arbitrary.arbitraryConstructor(Test_QuickCheck_Arbitrary.arbitraryArgument(Test_QuickCheck_Arbitrary.arbitraryRecordInstance()(Test_QuickCheck_Arbitrary.arbitraryRowListCons(arbitraryAuthor)(Test_QuickCheck_Arbitrary.arbitraryRowListCons(arbitraryDescription)(Test_QuickCheck_Arbitrary.arbitraryRowListCons(arbitraryURL)(Test_QuickCheck_Arbitrary.arbitraryRowListCons(arbitraryIssueDate)(Test_QuickCheck_Arbitrary.arbitraryRowListCons(arbitraryMoney)(Test_QuickCheck_Arbitrary.arbitraryRowListCons(arbitrarySubject)(Test_QuickCheck_Arbitrary.arbitraryRowListCons(arbitraryTitle)(Test_QuickCheck_Arbitrary.arbitraryRowListNil)()()()({
          reflectSymbol: function () {
              return "title";
          }
      }))()()()({
  ...
  exports["showIssueDate"] = showIssueDate;
  exports["showSubject"] = showSubject;
  exports["showMoney"] = showMoney;
  exports["arbitraryBook"] = arbitraryBook;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["BookTable"] = $PS["BookTable"] || {};
  var exports = $PS["BookTable"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Apply = $PS["Control.Apply"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  ...
  var ChangeIdx = (function () {
      function ChangeIdx(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangeIdx.create = function (value0) {
          return function (value1) {
              return new ChangeIdx(value0, value1);
          };
      };
      return ChangeIdx;
  })();
  ...
  var SortBy = (function () {
      function SortBy(value0) {
          this.value0 = value0;
      };
      SortBy.create = function (value0) {
          return new SortBy(value0);
      };
      return SortBy;
  })();
  var render = function (v) {
      var toTd = (function () {
          var $29 = Control_Applicative.pure(Control_Applicative.applicativeArray);
          return function ($30) {
              return Halogen_HTML_Elements.td_($29(Halogen_HTML_Core.text($30)));
          };
      })();
      var toNodes = function (v1) {
          return [ toTd(Data_Show.show(Types.showTitle)(v1.title)), toTd(Data_Show.show(Types.showAuthor)(v1.author)), toTd(Data_Show.show(Types.showIssueDate)(v1.issueDate)), toTd(Data_Show.show(Types.showSubject)(v1.subject)), toTd(Data_Show.show(Types.showDescription)(v1.description)), Halogen_HTML_Elements.td_(Control_Applicative.pure(Control_Applicative.applicativeArray)(Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src(Data_Show.show(Types.showURL)(v1.imageUrl)) ]))), toTd("$" + Data_Show.show(Types.showMoney)(v1.price)) ];
      };
      var tbody = Halogen_HTML_Elements.tbody_(Data_Functor.map(Data_Functor.functorArray)(function ($31) {
          return Halogen_HTML_Elements.tr_(toNodes($31));
      })(Data_Newtype.unwrap()(v.books)));
      var labels = [ "Title", "Author", "Issue Date", "Subject", "Description", "Image", "Price" ];
      var thead = Halogen_HTML_Elements.thead_(Control_Applicative.pure(Control_Applicative.applicativeArray)(Halogen_HTML_Elements.tr_(Data_Functor.map(Data_Functor.functorArray)((function () {
          var $32 = Halogen_HTML_Elements.th([ Halogen_HTML_Properties.scope(DOM_HTML_Indexed_ScopeValue.ScopeCol.value) ]);
          var $33 = Control_Applicative.pure(Control_Applicative.applicativeArray);
          return function ($34) {
              return $32($33(Halogen_HTML_Core.text($34)));
          };
      })())(labels))));
      return Halogen_HTML_Elements.table([ Utils.cl("table") ])([ thead, tbody ]);
  };
  var handleAction = (function () {
      var modifyAt$prime = function (idx) {
          return function (f) {
              return function (arr) {
                  return Data_Maybe.fromMaybe(arr)(Data_Array.modifyAt(idx)(f)(arr));
              };
          };
      };
      return function (v) {
          ...
          if (v instanceof SortBy) {
              return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var $20 = {};
                  for (var $21 in st) {
                  ...
                  $20.books = Safe_Coerce.coerce()(Data_Array.sortBy(v.value0))(st.books);
                  return $20;
          ...
          if (v instanceof ChangeIdx) {
              return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $24.books = Safe_Coerce.coerce()(modifyAt$prime(v.value0)(v.value1))(st.books);
                  return $24;
              }))(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  return v1.books;
              }))(Halogen_Query_HalogenM.raise));
          };
          throw new Error("Failed pattern match at BookTable (line 75, column 16 - line 80, column 121): " + [ v.constructor.name ]);
      };
  })();
  var bookTable = Halogen_Component.mkComponent({
...
(function($PS) {
  ...
  var component = function (dictMonadEffect) {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Utils.cl("container") ])(Control_Applicative.pure(Control_Applicative.applicativeArray)(Halogen_HTML.slot()({
              reflectSymbol: function () {
                  return "bookTable";
              }
          })(Data_Ord.ordUnit)(Type_Proxy["Proxy"].value)(Data_Unit.unit)(BookTable.bookTable)(state.books)(Raised.create)));
      };
      var handleAction = function (v) {
          if (v instanceof Initialize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Data_Functor.map(Effect.functorEffect)(Types.Books)(Test_QuickCheck_Gen.randomSample(Test_QuickCheck_Arbitrary.arbitrary(Types.arbitraryBook)))))(function (sampleData) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $6 = {};
                      for (var $7 in v1) {
          ...
          throw new Error("Failed pattern match at Main (line 50, column 20 - line 54, column 52): " + [ v.constructor.name ]);
      };
